...
<AutoSaveIndicator status={lessonSaveStatus} />
			...
			<button
				...
				title="Formely AI va fi disponibil în curând"
				aria-label="Formely AI — va fi disponibil în curând"
			>
				<span className="admin-course-builder-ai-fab-glow" aria-hidden="true" />
				<span className="admin-course-builder-ai-fab-label" aria-hidden="true">
					<Lightning size={20} weight="fill" className="admin-course-builder-ai-fab-icon" />
			...
			{showAiTestModal && aiTestAllowed && (
				<div className="ai-chat-modal-overlay" onClick={() => setShowAiTestModal(false)}>
					<div className="ai-chat-modal" onClick={(e) => e.stopPropagation()}>
						<AITestChat
							courseId={courseId}
							onTestGenerated={handleAiTestSaved}
