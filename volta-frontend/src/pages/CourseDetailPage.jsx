...
const CourseDetailPage = () => {
	...
	const totalTests = modules.reduce((sum, module) => sum + (module.courseTests?.length || 0), 0);
	const estimatedHours = course.estimated_duration_hours || Math.ceil(totalLessons * 0.5); // Estimate 30 min per lesson
				...
				<div className="course-detail-hero-content">
					...
					<div className="course-detail-hero-main">
						<div className="course-detail-hero-left">
							...
							{course.status && (
								<div className="course-detail-status-badge">
									{course.status === 'published' && <span className="course-status-badge live">● Live</span>}
							...
							<div className="course-detail-meta">
								...
								<div className="course-detail-meta-item">
									...
									<span>{estimatedHours} {estimatedHours === 1 ? 'oră' : 'ore'}</span>
								</div>
							...
							<div className="course-detail-actions">
								{isEnrolled ? (
									...
									>
										{progress && progress.progress_percentage > 0 ? 'Continuă cursul' : 'Începe cursul'}
									</button>
								) : (
									<button 
										className="lms-btn-primary course-detail-action-btn"
						...
						<div className="course-detail-hero-right">
							{course.image_url ? (
								<img src={course.image_url} alt={course.title} className="course-detail-thumbnail" />
							) : (
									...
									<div key={module.id} className="course-detail-module">
										...
										{module.courseTests && module.courseTests.length > 0 && (
											<div className="course-detail-tests">
												{module.courseTests.map((test) => (
													<div key={test.id} className="course-detail-test">
				...
				<div className="course-detail-sidebar">
					...
					<div className="course-detail-info-card">
						...
						<div className="course-detail-info-list">
							...
							<div className="course-detail-info-item">
								<span className="course-detail-info-label">Durată</span>
								<span className="course-detail-info-value">
									{estimatedHours} {estimatedHours === 1 ? 'oră' : 'ore'}
								</span>
							</div>
