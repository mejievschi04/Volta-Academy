...
import './AdminTestsPendingReviewsPage.css';
...
export default function AdminTestsPendingReviewsPage() {
	...
	return (
		<div className="admin-tests-pending-page admin-container">
			<button
				type="button"
				className="admin-tests-pending-back"
				onClick={() => navigate('/admin/content?tab=tests')}
			>
				← Înapoi la teste
			</button>
			<header className="admin-tests-pending-page-header">
				<div>
					<h1>Așteaptă verificare</h1>
