...
function Layout({ children }) {
	...
	// Admin Navigation - Organized by sections: Learning / Creation / Management
					...
					<aside className="modern-sidebar va-sidebar">
						...
						<nav className="modern-nav va-sidebar-nav">
							{adminNavSections.map((section, sectionIndex) => (
								<div key={section.title} className="modern-nav-section">
									<div className="modern-nav-section-title">{section.title}</div>
									...
									{sectionIndex < adminNavSections.length - 1 && (
										<hr className="modern-nav-section-divider" />
									)}
								</div>
							))}
						</nav>
						...
						<div className="va-sidebar-footer">
							<div style={{ marginBottom: '1rem', display: 'flex', justifyContent: 'center', gap: '0.75rem', alignItems: 'center' }}>
								<button
									onClick={() => navigate('/home')}
									className="theme-toggle"
									title="Vizualizare ca User"
									aria-label="Vizualizare ca User"
									style={{
										position: 'relative',
										width: '56px',
										height: '32px',
								...
								>
									<div 
										...
										style={{
											...
											transform: isUserPage ? 'translateX(24px)' : 'translateX(0)',
										}}
									>
								...
								<div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginRight: '1rem' }}>
									{isAdmin && (
										<button
											...
											className="theme-toggle"
											title={isUserPage ? "Vizualizare Admin" : "Vizualizare User"}
											aria-label={isUserPage ? "Vizualizare Admin" : "Vizualizare User"}
											style={{
												position: 'relative',
												width: '56px',
												height: '32px',
