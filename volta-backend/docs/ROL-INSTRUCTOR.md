...
Rolul **instructor** permite crearea și gestionarea **conținutului LMS** (cursuri, builder, module, lecții, examene, teste, bănci de întrebări, reguli de progresie, media, generare AI conținut), **fără** zona organizațională (utilizatori, echipe, evenimente admin, mape de cursuri, setări, statistici admin, export/import).

### Permisiuni (în limitele controllere-lor)

- **Cursuri**: CRUD doar unde `teacher_id` = utilizatorul curent (builder, module, lecții, progresie, teste atașate).
